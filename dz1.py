...
#elif n==6 or n==7:
#    print('Выходной день')
#else: print('Неверно введена цифра дня недели')
...
#else: print('Данной четверти нет!')
...
#6. Последовательностью Фибоначчи называется последовательность чисел a0, a1, ..., an, ..., где a0 = 0, a1 = 1,
# ak = ak-1 + ak-2 (k > 1).


fibo1 = fibo2 = 1
k = int(input("Номер элемента ряда Фибоначчи: "))
k = int(k) - 2
...
print("Значение этого элемента:", fibo2)
